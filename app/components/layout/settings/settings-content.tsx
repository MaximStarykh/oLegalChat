...
import { GearSixIcon, PaintBrushIcon, XIcon } from "@phosphor-icons/react"
...
export function SettingsContent({
  ...
  return (
    ...
    >
      ...
      {combined ? (
        <div className={cn("flex-1 overflow-auto", isDrawer ? "px-4 pt-2" : "px-6 pt-4") }>
          <div className={cn(isDrawer ? "space-y-6" : "mt-0 space-y-6") }>
            <UserProfile />
            {isSupabaseEnabled && (
              <>
                <AccountManagement />
