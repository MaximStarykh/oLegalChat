...
oLegal is a free, open-source AI chat app with multi-model support. This guide covers how to install and run oLegal on different platforms, including Docker deployment options.

![oLegal screenshot](./public/cover_oLegal.jpg)
...
oLegal supports BYOK functionality, allowing users to securely store and use their own API keys for AI providers. To enable this feature, you need to configure an encryption key for secure storage of user API keys.
